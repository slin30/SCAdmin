...
#' 
#' The expected typical input is a valid return from \code{\link{Classifications_GetTemplate}}, passed in
...
#' # file extension will automatically be stripped and output as '.tab'
#' my_files <- c("./rsid_1.tab", "./rsid_2") 
